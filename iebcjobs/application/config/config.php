...
|
*/
$config['base_url']	= 'http://197.248.28.242/iebcjobs/';
...
| variable so that iin the move to handle the move to is blank.
|
*/
$config['index_page'] = 'index.php';
$config['javascript_location'] = 'http://localhost/ateng/js/jquery.js';
...
|
*/
$config['encryption_key'] = 'qG579md23i6qIn2alkmhxYS';
