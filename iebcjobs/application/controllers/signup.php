...
$this->load->model('Users');
   ...
   public function sign_validate()
    ...
    $this->form_validation->set_rules('idno', 'The First', 'trim|required|numeric|min_length[4]|max_length[12]|xss_clean');
	$this->form_validation->set_rules('phone', 'Phone Number','trim|required|numeric|min_length[10]|max_length[15]|xss_clean');
...
$this->form_validation->set_rules('addresspersonal', 'Postal Address','trim|required|min_length[3]|alpa_numeric|max_length[50]|xss_clean');

$this->form_validation->set_rules('postalcode', 'Postal Code','trim|required|numeric|min_length[2]|max_length[15]|xss_clean');
$this->form_validation->set_rules('city', 'City','trim|required|min_length[3]|alpa_numeric|max_length[50]|xss_clean');
...
//$this->form_validation->set_rules('religion', 'Religion','trim|required|alpa_numeric|xss_clean');
//$this->form_validation->set_rules('current_terms_of_service', 'current terms of service','trim|required|alpa_numeric|xss_clean');
$this->form_validation->set_rules('current_position', 'current position','trim|required|alpa_numeric|xss_clean');
