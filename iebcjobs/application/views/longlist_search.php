...
<span class="loginerror"> <?php if ($this->session->flashdata('error') !== FALSE) { echo $this->session->flashdata('error'); } ?></span>
 ...
 <form action="<?php echo base_url()?>index.php/addcourse/longlist" method="post" />
...
<tr>
<td>Applicants with Scores Less than: </td><td><input type="number" name="score" placeholder="Enter the least percentage here...">% <td>
</tr>
<tr>
<td></td>
<td><input type="submit" class="btn btn-success"value="Long List Candidates"></td>
</tr>
...
<th>Job Title</th>
<th>Score(%)</th>
<?php if (isset($longlists)): foreach ($longlists as $sh): ?>
 <tr>
...
<a href="<?php echo site_url('addcourse/long_emails_view')?>" class="btn btn-danger btn-large">Send Email Notification </a>
