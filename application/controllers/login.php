...
// this is to sdfsdo dsfklin sf
	
		$emailid=$this->input->post('email');
		$password=$this->input->post('password');		
		$result=$this->Users->check($emailid, $password);
			
		//$phone =$this->session->userdata('phone');
		//$email =$this->session->userdata('email');
		$logged_in =$this->session->userdata('logged_in');
		$priv_id=$this->session->userdata('level_id');
		$pass_status=$this->session->userdata('password_status');
...
else if($result && $logged_in=true && $priv_id==3)
	{
	//$this->show_admin();
...
else if($result && $logged_in=true && $priv_id==4)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==5)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==6)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==7)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==8)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==9)
	{
	//$this->show_admin();
if($pass_status == 0)
{
...
else if($result && $logged_in=true && $priv_id==10)
	{
	//$this->show_admin();
if($pass_status == 0)
{
