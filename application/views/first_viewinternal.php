...
<div id="topcl"> </div>
 <div class="container">
<img src="<?php echo base_url()?>images/tzlogo.png" height="200px" width="200px">IEBC - Internal Job Application.
...
<form action="<?php echo base_url()?>index.php/login" method="post" onsubmit="return validate();">
 ...
 <tr>
 <td>ID Number: </td><td><input type="text" name="idno" id="idno"size="30px" autofocus="autofocus" required></td>
 </tr>
...
<input type="hidden" name="jobid" value="<?php echo $jid;?>">
 ...
 <td>Password: </td><td><input type="password" name="password" id="lpwd" size="30px" required></td>
  ...
  <tr>
 <td> </td><td><input type="submit" class="btn btn-success btn-large" id="lbutton" value="Login"></td>
  </tr>
  <tr>
  <td>
      </td>
<td>
  ...
  <tr>
  <td>
</td><td> New Member?  <a href="<?php echo site_url('login/reg_internal')?>" ><b> Register Now</b></a></td>
</tr>
