...
//alert('hey');
      //  $('#constituency').load('welcome/getcountybyid'+this.value);
   // });
});
</script>
...
<tr>
                    	<td align='right'><span class="reg">* </span> Wards:</td>
...
-->
                    ...
                    <td><input type='text' name='physical_location' size='40' id='physical_location' value="<?php echo set_value('physical_location')?>" required/></td>
                   		...
                   		<td align='right'>Current Postal Address:</td>
                    	<td><input type='text' name='addresspersonal' id='addresspersonal' value="<?php echo set_value('addresspersonal')?>" size='40' /></td></tr>
                    <tr>
                    	<td align='right'> Current Postal Code:</td>
                    	<td><input type='text' name='postalcode' id='postalcode'  value="<?php echo set_value('postalcode')?>" size='40'/></td></tr>
...
<tr>
                    	...
                    	<td><input type='text' name='religion' id='religion' size='40'  value="<?php echo set_value('religion')?>" /></td></tr>
...
-->
 ...
 <tr>
                    	<td align='right'> Current Term of service:</td>
                    	<td><input type='text' name='current_terms_of_service' id='current_terms_of_service' size='40' value="<?php echo set_value('current_terms_of_service')?>" /></td></tr>
                 	<tr>

 <tr>
                    	<td align='right'> Current Position:</td>
                    	<td><input type='text' name='current_position' id='current_position' size='40'  value="<?php echo set_value('current_position')?>"/></td></tr>
                 	<tr>


<!-- <tr>
                    	<td align='right'> Current Employment:</td>
                    	<td><input type='text' name='current_employment' id='current_employment' size='40' value="<?php echo set_value('current_employment')?>" /></td></tr>
-->
                 	<tr>

 <tr>
                    	<td align='right'> Current Work Station:</td>
                    	<td><input type='text' name='current_work_station' id='current_work_station' size='40' value="<?php echo set_value('current_work_station')?>"/></td></tr>
                 	<tr>

 <tr>
                    	<td align='right'><span class="reg">* </span> Disabled ?: </td>
