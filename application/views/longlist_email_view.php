...
<hr>
 ...
 <form action="<?php echo base_url()?>index.php/addcourse/longsendemail" method="post" />

Vacancy Number: <b><?php echo $this->session->userdata('vacnumber')?></b>
<h3> Sending Email to Long Listed Applicants <small>NB: The salutation will be automatic, please concentrate on the body of the email. </small></h3>
<label>Subject
</label>
